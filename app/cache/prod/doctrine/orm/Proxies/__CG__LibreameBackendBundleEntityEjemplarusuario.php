 ...
 */
class Ejemplarusuario extends \Libreame\BackendBundle\Entity\Ejemplarusuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ejemplarusuario $proxy) {
