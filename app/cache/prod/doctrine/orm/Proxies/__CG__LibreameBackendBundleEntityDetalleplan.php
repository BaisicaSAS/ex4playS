 ...
 */
class Detalleplan extends \Libreame\BackendBundle\Entity\Detalleplan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Detalleplan $proxy) {
