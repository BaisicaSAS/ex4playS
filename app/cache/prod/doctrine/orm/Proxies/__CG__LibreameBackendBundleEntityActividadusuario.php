 ...
 */
class Actividadusuario extends \Libreame\BackendBundle\Entity\Actividadusuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Actividadusuario $proxy) {
