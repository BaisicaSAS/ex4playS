...
class __TwigTemplate_d0445cfa35bd103367cf661efb62e76c83c798725e11ad78089c92f70cc2f90b extends Twig_Template
{
    private $source;
...
";
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["trace"] ?? null), "file", array(), "any", true, true) && twig_get_attribute($this->env, $this->source, ($context["trace"] ?? null), "line", array(), "any", true, true))) {
            // line 7
            echo "        in ";
            echo twig_get_attribute($this->env, $this->source, (isset($context["trace"]) || array_key_exists("trace", $context) ? $context["trace"] : (function () { throw new Twig_Error_Runtime('Variable "trace" does not exist.', 7, $this->source); })()), "file", array());
            echo " line ";
            echo twig_get_attribute($this->env, $this->source, (isset($context["trace"]) || array_key_exists("trace", $context) ? $context["trace"] : (function () { throw new Twig_Error_Runtime('Variable "trace" does not exist.', 7, $this->source); })()), "line", array());
            echo "
";
        }
    ...
    {
        return array (  42 => 7,  40 => 6,  36 => 4,  28 => 2,  26 => 1,);
    }
...
{% endif %}
", "TwigBundle:Exception:trace.txt.twig", "C:\\xampp\\htdocs\\ex4playS\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views/Exception/trace.txt.twig");
    }
}
