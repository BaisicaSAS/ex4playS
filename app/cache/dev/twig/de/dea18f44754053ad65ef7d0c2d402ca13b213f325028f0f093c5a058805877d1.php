...
class __TwigTemplate_07531f7a146080d08611795f57f218ce7b757e358d4a0446cc010b6caaa8e1e7 extends Twig_Template
{
    private $source;
    ...
    <div class=\"block-exception-detected clear-fix\">
        ...
        <div class=\"text-exception\">
            ...
            <h1>";
        // line 11
        echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 11, $this->source); })()), "message", array()), "html", null, true)));
        echo "</h1>

            <div>
                <strong>";
        // line 14
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new Twig_Error_Runtime('Variable "status_code" does not exist.', 14, $this->source); })()), "html", null, true);
        echo "</strong> ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new Twig_Error_Runtime('Variable "status_text" does not exist.', 14, $this->source); })()), "html", null, true);
        echo " - ";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 14, $this->source); })()), "class", array()));
        echo "
            </div>

            ";
        // line 17
        $context["previous_count"] = twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 17, $this->source); })()), "allPrevious", array()));
        // line 18
        echo "            ";
        if ((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 18, $this->source); })())) {
            // line 19
            echo "                <div class=\"linked\"><span><strong>";
            echo twig_escape_filter($this->env, (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 19, $this->source); })()), "html", null, true);
            echo "</strong> linked Exception";
            echo ((((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 19, $this->source); })()) > 1)) ? ("s") : (""));
            echo ":</span>
                    <ul>
                        ";
            // line 21
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 21, $this->source); })()), "allPrevious", array()));
...
";
        // line 37
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 37, $this->source); })()), "toarray", array()));
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 38)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 38, $this->source); })())));
        }
        $_parent = $context['_parent'];
...
";
        // line 41
        if ((isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 41, $this->source); })())) {
            // line 42
        ...
        <div class=\"logs clear-fix\">
            ...
            ";
            // line 54
            if (twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 54, $this->source); })()), "counterrors", array())) {
                // line 55
                echo "                <div class=\"error-count\">
                    <span>
                        ";
                // line 57
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 57, $this->source); })()), "counterrors", array()), "html", null, true);
                echo " error";
                echo (((twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 57, $this->source); })()), "counterrors", array()) > 1)) ? ("s") : (""));
                echo "
                    </span>
                </div>
            ";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 64)->display(array("logs" => twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 64, $this->source); })()), "logs", array())));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 69
        if ((isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 69, $this->source); })())) {
            // line 70
            echo "    <div class=\"block\">
        ";
            // line 71
        ...
        <div id=\"output-content\" style=\"display: none\">
            ";
            // line 82
            echo twig_escape_filter($this->env, (isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 82, $this->source); })()), "html", null, true);
            echo "
        </div>
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 89)->display(array("exception" => (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 89, $this->source); })())));
        // line 90
        echo "
...
";
    ...
    {
        return array (  206 => 90,  204 => 89,  201 => 88,  192 => 82,  188 => 80,  178 => 72,  176 => 71,  173 => 70,  171 => 69,  168 => 68,  163 => 65,  161 => 64,  156 => 61,  147 => 57,  143 => 55,  141 => 54,  138 => 53,  128 => 45,  126 => 44,  122 => 42,  120 => 41,  117 => 40,  110 => 38,  106 => 37,  96 => 29,  91 => 26,  74 => 23,  71 => 22,  67 => 21,  59 => 19,  56 => 18,  54 => 17,  44 => 14,  38 => 11,  26 => 1,);
    }
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "C:\\xampp\\htdocs\\ex4playS\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
