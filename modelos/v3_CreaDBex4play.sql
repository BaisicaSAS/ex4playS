...
-- Table `ex4play`.`lugar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ex4play`.`lugar` (
  ...
  `inlugpadre` INT NOT NULL COMMENT 'Padre o entidad de orden superior que contiene este lugar',
  `inlugelegible` INT NULL DEFAULT 0 COMMENT 'Indica si el registro puede ser elegido por un usuario 0: No elegible - 1 : Elegible',
  PRIMARY KEY (`inlugar`),
  INDEX `fk_lugar_lugar1_idx` (`inlugpadre` ASC),
...
CREATE TABLE IF NOT EXISTS `ex4play`.`usuario` (
  ...
  `txnickname` VARCHAR(45) NOT NULL COMMENT 'Nombre para mostrar',
  ...
  `usuario_inlugar` INT NOT NULL COMMENT 'Id del lugar del usuario - Principal, despues deben ser mas',
  PRIMARY KEY (`idusuario`),
  INDEX `fk_usuario_lugar1_idx` (`usuario_inlugar` ASC),
  CONSTRAINT `fk_usuario_lugar1`
    FOREIGN KEY (`usuario_inlugar`)
    REFERENCES `ex4play`.`lugar` (`inlugar`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Cada una de las acciones de un trato - Preguntas y cierre o ' /* comment truncated */ /*cancelación del trato*/;
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Registra cada una de las sesiones generadas por cada usuario' /* comment truncated */ /*.*/;
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Almacena los planes o suscripciones que se pueden adquirir e' /* comment truncated */ /*n ex4play*/;
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Tabla que almacena la configuración particular de cada uno ' /* comment truncated */ /*de los planes de suscripción de ex4play*/;
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Tabla que relaciona la historia de cada ejemplar de ex4play,' /* comment truncated */ /* en función de sus propietarios. Indica si esta publicado y si una relacion está vigente.*/;
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Tabla que indica el plan en que cada usuario está registrad' /* comment truncated */ /*o y la vigencia que tiene*/;
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'Relaciona todo el contenido que los usuarios adicionan a al ' /* comment truncated */ /*videojuego : Comentarios, reseñas, trucos*/;
